  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          backgroundImage: 'url("https://media.istockphoto.com/id/172396921/id/foto/gitar-tergantung-di-toko.jpg?s=1024x1024&w=is&k=20&c=couEgbMpSR2llNA8B2oy8IryLbos4tWKCh07JM2_u7o=")',
      ...
      >
        ...
        <div className="position-relative" style={{ zIndex: 2 }}>
          <h1 className="display-4 fw-bold">Selamat Datang di GigGear 🎶</h1>
          <p className="lead">Temukan alat musik terbaik untuk inspirasimu!</p>
        </div>
      </div>
      ...
      <footer className="bg-dark text-white text-center py-3 mt-5">
        <small>&copy; 2025 GigGear. All rights reserved.</small>
      </footer>
    </div>
  );
}
